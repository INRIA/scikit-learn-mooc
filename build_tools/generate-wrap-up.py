...
def write_jupyter_notebook_file(code_blocks, output_file="notebook_from_md.py"):
    """
    ...
    try:
        with open(output_file, 'w', encoding='utf-8') as file:
            ...
            print(f"Successfully wrote {len(code_blocks)} code cells to {output_file}")
    except Exception as e:
...
def process_quiz_files(input_path, output_dir):
    ...
    quiz_files = glob.glob(f"{input_path}/**/*wrap_up_quiz*.md", recursive=True)
