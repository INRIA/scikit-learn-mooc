...
depend on the regularization parameters. Assuming that class "1" (in red) is
the positive class, use the following figures to select the which statements
are true in this particular logistic regression model:
