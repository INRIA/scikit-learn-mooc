...
# method `set_output` controls this behaviour. Please refer to this [example from
# the scikit-learn documentation](https://scikit-learn.org/stable/auto_examples/miscellaneous/plot_set_output.html)
